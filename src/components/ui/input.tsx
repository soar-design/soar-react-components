...
const inputAddonVariants = cva(
  'flex items-center shrink-0 justify-center bg-background border-2 border-transparent shadow-sm shadow-[rgba(0,0,0,0.05)] text-secondary-foreground [&_svg]:text-secondary-foreground/60',
  {
    variants: {
      variant: {
        lg: 'rounded-full h-10 min-w-10 px-4 text-sm [&_svg:not([class*=size-])]:size-4.5',
        md: 'rounded-full h-8 min-w-9 px-3 text-sm [&_svg:not([class*=size-])]:size-4.5',
        sm: 'rounded-full h-6 min-w-7 text-sm px-2.5 [&_svg:not([class*=size-])]:size-3.5',
      },
      mode: {
        default: '',
