...
const cardHeaderVariants = cva('flex items-center justify-between flex-wrap px-5 py-3 min-h-14 gap-2.5', {
  variants: {
    variant: {
...
const cardFooterVariants = cva('flex items-center px-5 py-3 min-h-14', {
  variants: {
    variant: {
