...
const tabsListVariants = cva(
  "rounded-full p-1 group-data-[orientation=horizontal]/tabs:h-10 data-[variant=line]:rounded-none group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col relative",
  {
    variants: {
      variant: {
        default: "bg-accent dark:bg-secondary backdrop-blur-xl backdrop-saturate-150",
  ...
  return (
    ...
    >
      <div
        ref={indicatorRef}
        className={cn(
          "pointer-events-none absolute rounded-full bg-background shadow-sm transition-all duration-200 ease-out",
