  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "bg-accent text-accent-foreground rounded-full data-[selected=true]:rounded-none [&:last-child[data-selected=true]_button]:rounded-e-full [&:first-child[data-selected=true]_button]:rounded-s-full",
